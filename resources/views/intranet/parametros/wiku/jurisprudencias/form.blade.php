    ...
    <div class="col-12 col-md-6">
        <div class="row">
            <div class="col-12" id="cajaSubSala">
                ...
                <div class="input-group mb-3">
                    <select class="form-control form-control-sm" id="subsala_id" name="subsala_id" required>
                        <option value="">---Seleccione---</option>
                    </select>
                    <div class="input-group-append d-flex align-items-center">
                        <a class="btn btn-info btn-sm" id="nuevaSubSala"><i class="fa fa-plus-circle" aria-hidden="true"
                                style="cursor: pointer;"></i></a>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-12 col-md-3 form-group">
        ...
        <input type="text" class="form-control form-control-sm" name="radicado" id="radicado" aria-describedby="helpId"
            value="{{ old('radicado', $jurisprudencia->fuente ?? '') }}" placeholder="" required>
    ...
    <div class="col-12 col-md-6">
        <div class="row">
            <div class="col-12" id="cajaMagistrado">
                <label id="labelmagistrado_id" class="requerido" for="magistrado_id">Magistrado</label>
                <div class="input-group mb-3">
                    <select class="form-control form-control-sm magistradoClass" id="magistrado_id" name="magistrado_id"
                        required>
                        <option value="">---Seleccione---</option>
    ...
    <div class="col-12 col-md-6">
        <div class="row">
            <div class="col-12" id="cajaDemandante">
                ...
                <div class="input-group mb-3">
                    <select class="form-control form-control-sm" id="demandante_id" name="demandante_id">
                        <option value="">---Seleccione---</option>
